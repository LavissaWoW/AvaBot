...
module.exports.run = async(bot, message, args, langue) => {
    ...
    if(!command){
        ...
        .setDescription("In order to get ava verifyed i need her on 75+ server.\nIm still working on here so plis report buggs u find.\n\nAva's Role play commands has a counter when you tag another user!\nIt's only made to mention **1** user at the time!")
